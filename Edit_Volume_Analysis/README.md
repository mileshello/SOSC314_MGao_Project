...
2. Insert page names into "PAGES" set
3. Change the START_DATE and END_DATE values to fit the target timeperiod
4. (Optional) at the 9th code block, change the line marked with the comment "adds a line at point of interest" to a new date, indicating a specific event to be observed.
